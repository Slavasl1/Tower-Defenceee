...
public partial class GameEntity {
    ...
    public _GameLogic_.Common.AttackComponent attack { get { return (_GameLogic_.Common.AttackComponent)GetComponent(GameComponentsLookup.Attack); } }
    public bool hasAttack { get { return HasComponent(GameComponentsLookup.Attack); } }

    public void AddAttack(int newTargetHashcode) {
        var index = GameComponentsLookup.Attack;
        var component = (_GameLogic_.Common.AttackComponent)CreateComponent(index, typeof(_GameLogic_.Common.AttackComponent));
        component.targetHashcode = newTargetHashcode;
        AddComponent(index, component);
    }

    public void ReplaceAttack(int newTargetHashcode) {
        var index = GameComponentsLookup.Attack;
        var component = (_GameLogic_.Common.AttackComponent)CreateComponent(index, typeof(_GameLogic_.Common.AttackComponent));
        component.targetHashcode = newTargetHashcode;
