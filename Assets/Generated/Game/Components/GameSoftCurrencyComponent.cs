...
public partial class GameEntity {
    ...
    public void RemoveSoftCurrency() {
        RemoveComponent(GameComponentsLookup.SoftCurrency);
    }
}
...
public sealed partial class GameMatcher {
    ...
    static Entitas.IMatcher<GameEntity> _matcherSoftCurrency;

    public static Entitas.IMatcher<GameEntity> SoftCurrency {
        get {
            if (_matcherSoftCurrency == null) {
                var matcher = (Entitas.Matcher<GameEntity>)Entitas.Matcher<GameEntity>.AllOf(GameComponentsLookup.SoftCurrency);
